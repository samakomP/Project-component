...
<template>
  <div class="font-sans antialiased bg-white min-h-screen">
    ...
    <div id="flashMessage" v-if="message" class="fixed top-3 left-1/2 -translate-x-1/2 w-fit z-50 shadow-md rounded-3xl px-6 py-3 bg-yellow-200">
