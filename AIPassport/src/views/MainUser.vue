  ...
  <div class="max-w-5xl mx-auto p-6 mt-4">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <div class="md:col-span-2 flex flex-col gap-8">
        <CardBase class="text-center p-12">
        ...
        <div class="grid grid-cols-2 gap-8">
          <RouterLink to="/e-learning">
            <CardBase class="h-full flex flex-col items-center justify-center gap-4 hover:opacity-80 transition">
              ...
              <h2 class="text-2xl font-bold text-gray-900">E-Learning</h2>
            </CardBase>
          </RouterLink>
          ...
          <RouterLink to="/exam">
            <CardBase class="h-full flex flex-col items-center justify-center gap-4 hover:opacity-80 transition">
              ...
              <h2 class="text-2xl font-bold text-gray-900">Exam</h2>
            </CardBase>
          </RouterLink>
        </div>
      </div>
      ...
      <RouterLink to="/benefits">
        <CardBase class="h-full text-center flex flex-col items-center hover:opacity-90 transition">
