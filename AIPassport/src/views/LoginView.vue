...
const handleLogin = async () => {
  ...
  if (role === 'admin') {
    ...
    alert('Access Denied: Please use Admin1, user1, or user2.')
  }
}
</script>
  ...
  <CardAuth>
    ...
    <template #default>
      <form @submit.prevent="handleLogin" class="space-y-5">
        ...
        <button 
          type="submit" 
          class="btn w-full px-4 py-3 bg-gray-900 text-white font-medium rounded-xl hover:bg-gray-800 transition-colors">
          Login with Email
        </button>
    ...
    <template #footer>
      <div class="flex items-center mb-6">
        ...
        <span class="px-4 text-sm text-gray-500 bg-tranparent">or</span>
        <div class="flex-grow border-t border-gray-200"></div>
      </div>
